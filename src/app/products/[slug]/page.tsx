      ...
      <div className="grid gap-10 px-6 pt-8 lg:grid-cols-2 lg:gap-16 lg:px-14 lg:pt-14">
        ...
        */}
        ...
        <div className="order-2 min-w-0 lg:order-1">
          ...
          <p
            className="mt-8 font-body uppercase tracking-[0.14em] text-accent"
            style={{ fontSize: "var(--text-body-sm)" }}
          >
            {product.badge}
          </p>
          ...
          <ProductEnquiry name={product.name} slug={product.slug} />

          {product.description && (
            <div className="prose-gi mt-10 max-w-xl font-body leading-relaxed">
