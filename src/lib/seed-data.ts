...
export type SeedProduct = {
  ...
  colours?: string[];
  /**
   * Sub-group within a collection, e.g. the two panel sizes of the vertical
   * garden range. When products in a collection carry this, the collection
   * page tabs between the groups instead of listing everything in one grid.
   */
  size?: string;
  images: string[];
};
...
export const COLLECTIONS: SeedCollection[] = [
  ...
  },
  {
    ...
    group: "Interiors",
    icon: "🧶",
    image: "/catalog/vertical-garden/ag-3026-4687.jpg",
    blurb:
      "Artificial green wall panels in two sizes — no watering, no sunlight, no upkeep.",
  },
  {
    slug: "wall-cladding",
    name: "Wall Cladding",
...
/**
 * Vertical garden mats — artificial green wall panels.
 *
 * These sit under the wall-to-wall-carpets collection: the supplier ranges
 * them with its broadloom, and they are sold the same way — by coverage area,
 * laid across a whole surface rather than as a single finished item.
 *
 * Two panel sizes, kept as separate `size` groups so the collection page can
 * tab between them: 50x50 cm (2.69 sqft) and 1M x 1M (10.76 sqft).
 *
 * Product codes, sizes and coverage areas are exactly as printed. The
 * catalogues carry no fibre spec, weight or warranty table, so nothing
 * beyond that is claimed here.
 */
export const VERTICAL_GARDEN_PRODUCTS: SeedProduct[] = [
  {
    slug: "vertical-garden-ag-98gb-839",
    name: "AG-98GB-839",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-98GB-839, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
      ...SPEC_BASE,
    ],
    details: [
      { label: "Product Code", value: "AG-98GB-839" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
      ...MADE_TO_ORDER,
    ],
    images: ["/catalog/vertical-garden/ag-98gb-839.jpg"],
  },
  {
    slug: "vertical-garden-ag-98gr-839",
    name: "AG-98GR-839",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-98GR-839, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-98GR-839" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-98gr-839.jpg"],
  },
  {
    slug: "vertical-garden-ag-2018-834",
    name: "AG-2018-834",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-2018-834, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-2018-834" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-2018-834.jpg"],
  },
  {
    slug: "vertical-garden-ag-2017-835",
    name: "AG-2017-835",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-2017-835, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-2017-835" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-2017-835.jpg"],
  },
  {
    slug: "vertical-garden-ag-2024-854",
    name: "AG-2024-854",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-2024-854, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-2024-854" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-2024-854.jpg"],
  },
  {
    slug: "vertical-garden-ag-2034-852",
    name: "AG-2034-852",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-2034-852, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-2034-852" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-2034-852.jpg"],
  },
  {
    slug: "vertical-garden-ag-2037-910",
    name: "AG-2037-910",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-2037-910, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-2037-910" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-2037-910.jpg"],
  },
  {
    slug: "vertical-garden-ag-2036-894",
    name: "AG-2036-894",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-2036-894, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-2036-894" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-2036-894.jpg"],
  },
  {
    slug: "vertical-garden-ag-2040-837",
    name: "AG-2040-837",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-2040-837, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-2040-837" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-2040-837.jpg"],
  },
  {
    slug: "vertical-garden-ag-2038-901",
    name: "AG-2038-901",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-2038-901, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-2038-901" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-2038-901.jpg"],
  },
  {
    slug: "vertical-garden-ag-2047-890",
    name: "AG-2047-890",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-2047-890, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-2047-890" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-2047-890.jpg"],
  },
  {
    slug: "vertical-garden-ag-2045-837",
    name: "AG-2045-837",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-2045-837, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-2045-837" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-2045-837.jpg"],
  },
  {
    slug: "vertical-garden-ag-2051-901",
    name: "AG-2051-901",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-2051-901, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-2051-901" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-2051-901.jpg"],
  },
  {
    slug: "vertical-garden-ag-2048-946",
    name: "AG-2048-946",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-2048-946, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-2048-946" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-2048-946.jpg"],
  },
  {
    slug: "vertical-garden-ag-8012a-859",
    name: "AG-8012A-859",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-8012A-859, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-8012A-859" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-8012a-859.jpg"],
  },
  {
    slug: "vertical-garden-ag-8015a-757",
    name: "AG-8015A-757",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-8015A-757, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-8015A-757" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-8015a-757.jpg"],
  },
  {
    slug: "vertical-garden-ag-8015r-757",
    name: "AG-8015R-757",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-8015R-757, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-8015R-757" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-8015r-757.jpg"],
  },
  {
    slug: "vertical-garden-ag-8015b-757",
    name: "AG-8015B-757",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-8015B-757, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-8015B-757" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-8015b-757.jpg"],
  },
  {
    slug: "vertical-garden-ag-8015o-757",
    name: "AG-8015O-757",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-8015O-757, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-8015O-757" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-8015o-757.jpg"],
  },
  {
    slug: "vertical-garden-ag-8015m-757",
    name: "AG-8015M-757",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-8015M-757, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-8015M-757" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-8015m-757.jpg"],
  },
  {
    slug: "vertical-garden-ag-8015k-757",
    name: "AG-8015K-757",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-8015K-757, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-8015K-757" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-8015k-757.jpg"],
  },
  {
    slug: "vertical-garden-ag-8025-728",
    name: "AG-8025-728",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-8025-728, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-8025-728" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-8025-728.jpg"],
  },
  {
    slug: "vertical-garden-ag-8035c-792",
    name: "AG-8035C-792",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-8035C-792, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-8035C-792" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-8035c-792.jpg"],
  },
  {
    slug: "vertical-garden-ag-8025e-637",
    name: "AG-8025E-637",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-8025E-637, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-8025E-637" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-8025e-637.jpg"],
  },
  {
    slug: "vertical-garden-ag-8035h-828",
    name: "AG-8035H-828",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-8035H-828, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-8035H-828" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-8035h-828.jpg"],
  },
  {
    slug: "vertical-garden-ag-8035i-828",
    name: "AG-8035I-828",
    collection: "wall-to-wall-carpets",
    size: "50x50 cm",
    badge: "50x50 cm",
    description:
      "Artificial green wall panel AG-8035I-828, a 50 x 50 cm mat covering 2.69 sqft. Panels interlock edge to edge, so a wall of any size is built up from the same tile.",
    specs: [
      "Panel size 50 x 50 cm — covers 2.69 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-8035I-828" },
      { label: "Panel Size", value: "50 x 50 cm" },
      { label: "Coverage", value: "2.69 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-8035i-828.jpg"],
  },
  {
    slug: "vertical-garden-ag-3001-3249",
    name: "AG-3001-3249",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-3001-3249, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
      ...SPEC_BASE,
    ],
    details: [
      { label: "Product Code", value: "AG-3001-3249" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
      ...MADE_TO_ORDER,
    ],
    images: ["/catalog/vertical-garden/ag-3001-3249.jpg"],
  },
  {
    slug: "vertical-garden-ag-3003-4150",
    name: "AG-3003-4150",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-3003-4150, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-3003-4150" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-3003-4150.jpg"],
  },
  {
    slug: "vertical-garden-ag-3006-4641",
    name: "AG-3006-4641",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-3006-4641, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-3006-4641" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-3006-4641.jpg"],
  },
  {
    slug: "vertical-garden-ag-3009a-4605",
    name: "AG-3009A-4605",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-3009A-4605, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-3009A-4605" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-3009a-4605.jpg"],
  },
  {
    slug: "vertical-garden-ag-3013-4450",
    name: "AG-3013-4450",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-3013-4450, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-3013-4450" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-3013-4450.jpg"],
  },
  {
    slug: "vertical-garden-ag-3015-4641",
    name: "AG-3015-4641",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-3015-4641, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-3015-4641" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-3015-4641.jpg"],
  },
  {
    slug: "vertical-garden-ag-3022-4596",
    name: "AG-3022-4596",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-3022-4596, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-3022-4596" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-3022-4596.jpg"],
  },
  {
    slug: "vertical-garden-ag-3023-4432",
    name: "AG-3023-4432",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-3023-4432, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-3023-4432" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-3023-4432.jpg"],
  },
  {
    slug: "vertical-garden-ag-3024-4677",
    name: "AG-3024-4677",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-3024-4677, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-3024-4677" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-3024-4677.jpg"],
  },
  {
    slug: "vertical-garden-ag-3026-4687",
    name: "AG-3026-4687",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-3026-4687, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-3026-4687" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-3026-4687.jpg"],
  },
  {
    slug: "vertical-garden-ag-3028-4687",
    name: "AG-3028-4687",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-3028-4687, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-3028-4687" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-3028-4687.jpg"],
  },
  {
    slug: "vertical-garden-ag-3029-4414",
    name: "AG-3029-4414",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-3029-4414, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-3029-4414" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-3029-4414.jpg"],
  },
  {
    slug: "vertical-garden-ag-3030-3749",
    name: "AG-3030-3749",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-3030-3749, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-3030-3749" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-3030-3749.jpg"],
  },
  {
    slug: "vertical-garden-ag-3031-4687",
    name: "AG-3031-4687",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-3031-4687, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-3031-4687" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-3031-4687.jpg"],
  },
  {
    slug: "vertical-garden-ag-3032-4687",
    name: "AG-3032-4687",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-3032-4687, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-3032-4687" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-3032-4687.jpg"],
  },
  {
    slug: "vertical-garden-ag-3034-4687",
    name: "AG-3034-4687",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-3034-4687, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-3034-4687" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-3034-4687.jpg"],
  },
  {
    slug: "vertical-garden-ag-3035-4687",
    name: "AG-3035-4687",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-3035-4687, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-3035-4687" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-3035-4687.jpg"],
  },
  {
    slug: "vertical-garden-ag-3036-4368",
    name: "AG-3036-4368",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-3036-4368, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-3036-4368" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-3036-4368.jpg"],
  },
  {
    slug: "vertical-garden-ag-3037",
    name: "AG-3037",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-3037, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-3037" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-3037.jpg"],
  },
  {
    slug: "vertical-garden-ag-9048-4912",
    name: "AG-9048-4912",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-9048-4912, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-9048-4912" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-9048-4912.jpg"],
  },
  {
    slug: "vertical-garden-ag-5001-3576",
    name: "AG-5001-3576",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-5001-3576, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-5001-3576" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-5001-3576.jpg"],
  },
  {
    slug: "vertical-garden-ag-5002-4159",
    name: "AG-5002-4159",
    collection: "wall-to-wall-carpets",
    size: "1M x 1M",
    badge: "1M x 1M",
    description:
      "Artificial green wall panel AG-5002-4159, a 1M x 1M mat covering 10.76 sqft. The larger format covers a wall in fewer tiles, with correspondingly fewer visible joins.",
    specs: [
      "Panel size 100 x 100 cm — covers 10.76 sqft",
      "Interlocking panels, trimmed to fit the wall",
      "No watering, sunlight or upkeep",
    ...
    details: [
      { label: "Product Code", value: "AG-5002-4159" },
      { label: "Panel Size", value: "100 x 100 cm" },
      { label: "Coverage", value: "10.76 sqft per panel" },
      { label: "Type", value: "Artificial vertical garden mat" },
      { label: "Use", value: "Indoor and outdoor" },
    ...
    images: ["/catalog/vertical-garden/ag-5002-4159.jpg"],
  },
];
