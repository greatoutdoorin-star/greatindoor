...
/**
 * Quantity picker plus the WhatsApp enquiry — this site's only conversion
 * action. Quantity is kept because "I want 6 of these" is a materially better
 * lead for made-to-order furniture; it rides along in the message.
 */
export default function ProductEnquiry({ name, slug }: Props) {
  const [qty, setQty] = useState(1);

  const href = productEnquiryLink({ name, qty, slug });
