...
export default function WhatsAppFab({ template, number }: Props) {
  return (
    <a
      ...
      // Smaller and tighter into the corner on mobile: at 56px it sat over the
      // second column of the product grid and covered card text.
      className="fixed bottom-4 right-4 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-whatsapp shadow-lg transition-transform hover:scale-105 hover:bg-whatsapp-hover lg:bottom-6 lg:right-6 lg:h-14 lg:w-14"
    >
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
